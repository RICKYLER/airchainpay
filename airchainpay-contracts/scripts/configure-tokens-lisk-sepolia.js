...
// Lisk Sepolia token configurations
...
async function configureTokensForLiskSepolia() {
  console.log("⚙️  AirChainPayToken - Lisk Sepolia Token Configuration");
  console.log("=======================================================");
  ...
  try {
    ...
    for (const [tokenName, tokenConfig] of Object.entries(LISK_SEPOLIA_TOKENS)) {
