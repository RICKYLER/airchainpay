...
async function deployTokenContractToBaseSepolia() {
  console.log("🌐 AirChainPayToken - Base Sepolia Testnet Deployment");
  console.log("====================================================");
  ...
  try {
    ...
    const existingIndex = masterData.deployments.findIndex(d => d.network === "base_sepolia" && d.contractName === "AirChainPayToken");
    if (existingIndex >= 0) {
...
// Handle errors
deployTokenContractToBaseSepolia()
  .then(() => process.exit(0))
  .catch((error) => {
