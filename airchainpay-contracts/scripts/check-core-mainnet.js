...
async function checkCoreMainnetDeployment() {
  console.log("🔍 AirChainPay - Core Mainnet Deployment Check");
  console.log("==============================================");
  ...
  try {
    ...
    if (!fs.existsSync(deploymentFile)) {
      console.log("❌ No deployment found for Core Mainnet");
      console.log("💡 To deploy, run: npx hardhat run scripts/deploy-core-mainnet.js --network core_mainnet");
      return;
    }
    ...
    console.log(`\n💰 Deployer balance: ${ethers.formatEther(balance)} CORE`);
    ...
    console.log(`   Network Info: https://chainlist.org/chain/1116`);
