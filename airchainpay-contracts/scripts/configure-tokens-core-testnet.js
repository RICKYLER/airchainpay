...
// Core Testnet token configurations
const CORE_TESTNET_TOKENS = {
...
async function configureTokensForCoreTestnet() {
  console.log("⚙️  AirChainPayToken - Core Testnet Token Configuration");
  console.log("=======================================================");
  ...
  try {
    ...
    for (const [tokenName, tokenConfig] of Object.entries(CORE_TESTNET_TOKENS)) {
