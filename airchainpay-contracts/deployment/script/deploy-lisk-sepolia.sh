...
# AirChainPay - Lisk Sepolia Deployment Script
# Deploys both AirChainPay and AirChainPayToken contracts with proper configuration

set -e

echo "🚀 AirChainPay - Lisk Sepolia Deployment"
echo "========================================"
...
npx hardhat run scripts/deploy-airchainpay-lisk-sepolia.js --network lisk_sepolia

# Step 2: Deploy AirChainPayToken contract
echo "📦 Step 2: Deploying AirChainPayToken contract..."
npx hardhat run scripts/deploy-token-contract-lisk-sepolia.js --network lisk_sepolia

# Step 3: Configure tokens
echo "⚙️  Step 3: Configuring supported tokens..."
npx hardhat run scripts/configure-tokens-lisk-sepolia.js --network lisk_sepolia
...
echo ""
echo "🎉 Lisk Sepolia deployment completed successfully!"
echo "📄 Check deployments/lisk_sepolia.json for contract addresses"
echo "🔗 View contracts at: https://sepolia.lisk.com" 